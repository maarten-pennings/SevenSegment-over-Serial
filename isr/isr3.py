# isr3.py - Timer to activate units in a cycle - split in slots for brightness control - support for blinking
...
brightness = 1        # User configuration: desired brightness level
...
print( f"user  : content '{framebuf}', brightness {brightness}/{SLOTCOUNT}, blink={frameson}/{framecount}")
...
print()
print( f"For brightness, column is only on {brightness} of {SLOTCOUNT} ISRs; for blinking {frameson} of {framecount} frames")
